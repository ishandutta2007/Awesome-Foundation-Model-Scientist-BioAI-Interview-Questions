...
- If a question is company-specific (e.g., "asked at EvolutionaryScale"), you may note it, but write the answer generically so it's useful to everyone.
- Cite sources for any specific statistics, benchmark numbers, or claims about specific published models.
- Flag when a technique, architecture, or benchmark is evolving quickly (this is one of the fastest-moving subfields in ML) so readers know to verify against current literature.
- Avoid stating unsettled research claims (e.g., about emergent capabilities or scaling behavior) as settled fact; note when something is an active area of research or debate.
...
Be kind. Many contributors and readers are early in their careers or transitioning from general ML research into biology, or from computational biology into ML research — write answers you'd have wanted when you were starting out.
